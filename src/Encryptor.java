...
public class Encryptor {
    ...
    /**
     * Counters for how many messages have been encoded/decoded for each scheme.
     */
    private static int countBaseNEncode = 0;
    private static int countBaseNDecode = 0;
    private static int countCaesarEncode = 0;
    private static int countCaesarDecode = 0;
    private static int countRotateEncode = 0;
    private static int countRotateDecode = 0;
    ...
    public static String encryptionTallyString() {
        return "Base-n encode count: " + countBaseNEncode +
                "\nBase-n decode count: " + countBaseNDecode +
                "\nCaesar encode count: " + countCaesarEncode +
                "\nCaesar decode count: " + countCaesarDecode +
                "\nBlock rotation encode count: " + countRotateEncode +
                "\nBlock rotation decode count: " + countRotateDecode;
    }
}